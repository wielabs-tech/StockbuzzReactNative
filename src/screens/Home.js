  ...
  return (
    <SafeAreaView style={{ backgroundColor: "#fff", height: '100%' }}>
      ...
      <View style={{ marginTop: 10, height: '100%' }}>
        <View style={{ flexDirection: 'row', height: 52, alignItems: 'center', justifyContent: 'space-around' }}>
          ...
          }} name="notifications" size={24} style={{ marginRight: 10 }} />
        </View>
        <View style={{ marginLeft: 10, marginTop: 10 }}>
          <Text style={{ marginBottom: 5, fontSize: 16, color: '#4955BB', marginLeft: 5, fontWeight: '600' }}>Groups</Text>
          <FlatList
        ...
        <View style={{ marginLeft: 10, marginTop: 10 }}>
          <Text style={{ marginBottom: 5, fontSize: 16, color: '#4955BB', marginLeft: 5, fontWeight: '600' }}>My Groups</Text>
          <FlatList
            style={{ backgroundColor: '#fff' }}
            showsHorizontalScrollIndicator={false}
            horizontal={true}
        ...
        <View style={{ flexDirection: 'row', flex: 1, paddingBottom: 10 }}>
          ...
          />
          <TouchableOpacity
            style={{ position: 'absolute', top: 30, right: 10, fontSize: 10, color: '#aaa' }}
            onPress={() => {
