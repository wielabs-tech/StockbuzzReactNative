...
export default LoginScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    GoogleSignin.configure({
      webClientId:
        "985903233562-jdh16qj2dnpv6kddht4quapuaos5fpe7.apps.googleusercontent.com",
    });
  }, []);
  ...
  const signIn = async () => {
    try {
      ...
      console.log("RESPONSELOGIN", loginResponse);
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.socialIcons}>
            <TouchableOpacity onPress={onClickFacebook}>
