            ...
            <View style={styles.box}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <Text style={{ fontSize: 12, alignSelf: 'flex-end' }}>{roundOff(item?.quote?.USD?.price, 2)}</Text>
                    </View>
                    <View style={{ flexDirection: 'row' }}>
                        {item?.quote?.USD?.percent_change_1h > 0 ?
                        ...
                        <Text style={{
                            color: item?.quote?.USD?.percent_change_1h > 0 ? "green" : "red",
                            fontSize: 10, alignSelf: 'flex-end'
                        }}>{roundOff(item?.quote?.USD?.percent_change_1h * item?.quote?.USD?.price, 2)}({roundOff(item?.quote?.USD?.percent_change_1h, 2)}%)</Text>
                    </View>
                </View>
            </View>
        </TouchableWithoutFeedback>
